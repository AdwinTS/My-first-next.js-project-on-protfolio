...
export default function Home() {
  return (
    <main ><h1 className='font-bold p-6'>Hello Everyone I am Adwin T Sunil</h1>
    <h2 className='py-5 '>To get started I am passionate computer science student who looks for every oportuinties and like coding very much</h2>
